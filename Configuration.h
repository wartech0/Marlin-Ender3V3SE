...
#define STRING_CONFIG_H_AUTHOR "Wartech" // Who made the changes.
...
//Power selection using switching power supply。  Switching power
...
#define CREALITY_LEVEL_COMPENSATION_ALGORITHM   1 //1 Algorithm used 0 Algorithm not applicable
  ...
  #define ALGORITHM_INFO_PRINT  0 //Leveling algorithm information printing
  #define LEVEL_ALGORITHM_MIN  -0.7 //Lower bound using automatic leveling algorithm
  #define LEVEL_ALGORITHM_MAX   0.7 //Upper bound using automatic leveling algorithm
#endif
#define USE_BEEPER 1
#define PLATFORM_OFFSET         1 //1: The back plate of the structural part is 2.5mm, and the firmware needs to be offset. 0: The back plate of the structural part is not offset.
#define HIGH_SPEED              1 //High speed mode 1: Turn on high speed mode 150mm/s; 0: Low speed mode 80mm/s
#define HIGH_SPEED_1            1 //Only switch high-speed macro  
#define SHOW_GRID_VALUES        1 //1 Display the auto-leveling grid value 0 Do not display the auto-leveling grid value 
#define K8_EXTRUDER             0 //1 is K8 extruder 0 is Elf extruder
#define USER_LEVEL_CHECK        1 //Leveling calibration enable
#define WUHAN_CHENGE_PLATFORM   1 //Wuhan platform reform board 20230913_Rock
//After turning on the high-speed printing macro, a high temperature alarm will occur due to the vibration compensation function.
 ...
 */
#if ENABLED(K8_EXTRUDER)  //K8 Extruder power transfer ratio
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 100.5} //20230209 Actual measurement found that the theoretical length was inconsistent with the actual discharging length.
#else  //Elf extruder power transfer ratio
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 424.9} //20230209 Actual measurement found that the theoretical length was inconsistent with the actual discharging length.
#endif
 ...
 *     O-- FRONT --+
 */
//#define NOZZLE_TO_PROBE_OFFSET { -24.75, -32.50, 0 }
#if ENABLED(PLATFORM_OFFSET)  //Requires platform offset

#if ENABLED(K8_EXTRUDER) //K8 extruder power transfer ratio
  #define NOZZLE_TO_PROBE_OFFSET { -31.88, -16.5, 0 } //prime 2023.03,13 Provided by Chen Gong
#else //Elf extruder power transfer ratio
  #define NOZZLE_TO_PROBE_OFFSET { -24.25, -15, 0 } //prime 2023.05.28 Provided by Zhu Gong
#endif
...
#if ENABLED(K8_EXTRUDER) //K8 extruder line sequence
 #define INVERT_E0_DIR true
#else //Elven extruder line sequence
...
// Travel limits (mm) after homing, corresponding to endstop positions.
  ...
  #if ENABLED(WUHAN_CHANGE_PLATFORM) //Wuhan changes structure
    #define X_MIN_POS -13 //Platform moves to the left
    #define Y_MIN_POS -15
  #else
    #define X_MIN_POS -11 //Platform moves to the left
    #define Y_MIN_POS -18 //The platform moves forward rock_20220927
  #endif
#else //
#define X_MIN_POS -4
#define Y_MIN_POS -17
...
#define Z_MAX_POS 250 //Since the slicing software does not limit the height of 250mm, the height is temporarily increased by 5mm Rock——20230105
...
//#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { {  5, 5, (Z_MIN_POS) } }
  #define NOZZLE_CLEAN_END_POINT   { { 10, 10, (Z_MIN_POS) } }
